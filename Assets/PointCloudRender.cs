...
namespace AssemblyCSharp {
	...
	public class PointCloudRender : MonoBehaviour {
		...
		void Start () {
			...
			mesh.vertices = new Vector3[xyz_count];
			mesh.colors = new Color[xyz_count];
			for(int i=0;i<xyz_count;i++)
			{
				...
				mesh.colors[i] = new Color(66,255,35);
			}
			Debug.Log (xyz_parcel.GetLength(0));
